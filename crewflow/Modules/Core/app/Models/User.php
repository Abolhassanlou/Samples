 ...
 * if those fields lived here, the Core module would be forced to depend on
 * the Organization module (for Branch), which would violate the project's
 * layered dependency direction (Core must remain layer zero, with no
